...
* Day 7: Another int-code day and we will have to rewrite how my machine handles input and output some more to be able to handle this puzzle. It will need an automated way for the input to come in and a way to take action on output